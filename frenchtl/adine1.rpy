...
translate frenchtl adine1_b66a50f0:
    ...
    m "﻿Je me souvins des paroles d'Adine concernant les livraisons que le café pouvait également faire et, n'ayant rien de mieux à faire, je me dis que je devrais essayer. Je fis ma commande par un rapide coup de téléphone, et ce ne fut pas long avant que la sonnette de la porte ne sonne."
...
translate frenchtl adine1_ba9efa2f:
    ...
    c "Ils ont changé leur fusil d'épaule, je suppose que vous serez coincé avec moi un peu plus longtemps."
...
translate frenchtl adine1_7c3e6087:
    ...
    Ad "Je me rappelle de ton nom, cependant. C'était... [player_name], correct ?"
...
translate frenchtl adine1_9d2d1212:
    ...
    Ad "Ça ne devrait pas être une surprise, puisque tu sais que je fais des livraisons pour le café."
...
translate frenchtl adine1choice1_e6f972e8:
    ...
    Ad "Il pleut beaucoup dehors, c'est tout."
...
translate frenchtl adine1choice1_8c2647a6:
    ...
    m "Je m'apprêtais à lui refermer la porte au nez quand elle prit soudainement la parole."
...
translate frenchtl menadine_07803e25:
    ...
    n "Le problème est que je n'avais pas commandé de nouilles. Je courus à la porte, me demandant ce qu'il s'était passé et ce que j'avais fait pour mériter ça, mais il était trop tard."

# game/adine1.rpy:131
translate frenchtl menadine_54475cd1:

    # n "Adine was already gone."
    n "Adine était déjà partie."
...
translate frenchtl _call_skipcheck_10_e53dbbb3:
    ...
    c "Fais comme chez toi. Je ferais mieux de manger avant que ça devienne froid."
...
translate frenchtl _call_skipcheck_10_f212dc62:
    ...
    m "Je m'assis à la table et commençai à manger mon repas alors qu'Adine décida de s'asseoir en face de moi."
...
translate frenchtl _call_skipcheck_10_d2241b6c:
    ...
    c "Oui, cette fois j'ai commandé quelque chose que je savais que j'aimerais. Je ne voulais pas faire la même erreur que tantôt aujourd'hui."

# game/adine1.rpy:265
translate frenchtl _call_skipcheck_10_d9534b58:

    # c "Yeah, it's actually quite good."
    c "Oui, c'est pas mal en fait."

# game/adine1.rpy:267
translate frenchtl _call_skipcheck_10_502163a4:

    # Ad "Do you have something similar where you come from?"
    Ad "Vous avez quelque chose de semblable là d'où tu viens ?"
...
translate frenchtl _call_skipcheck_10_a47ef0d2:
    ...
    c "Oui. En vrai, c'est quasi-effrayant à quel point les choses ici sont similaires à ce que nous avons chez moi."

# game/adine1.rpy:272
translate frenchtl _call_skipcheck_10_1571c3b3:

    # Ad "Really? Maybe we all just share a similar taste."
    Ad "Vraiment ? Peut-être partage-t-on simplement des goûts similaires."

# game/adine1.rpy:278
translate frenchtl _call_skipcheck_10_f57b79ce:

    # Ad "At least, that's what I think."
    Ad "Du moins, c'est ce que je pense."
...
translate frenchtl _call_skipcheck_10_e241a15e:
    ...
    c "Eh bien, ne retracez-vous pas vos origines aux humains d'une manière ou d'une autre? Je sais le genre de réputation que nous avons dans votre culture."
...
translate frenchtl _call_skipcheck_10_45ce6c6a:
    ...
    c "Laisse-moi te demander ceci : d'où penses-tu que le portail vienne ? Qui l'a construit ?"

# game/adine1.rpy:288
translate frenchtl _call_skipcheck_10_ef636fcf:

    # Ad "Humans did it, of course."
    Ad "Les humains, bien sûr."
...
translate frenchtl _call_skipcheck_10_4ab51b92:
    ...
    c "Exactement. Si vous croyez que les humains ont un lien avec un artéfact créé il y a on ne sait pas combien d'années, ça ne serait pas exagéré de penser qu'ils auraient pu vous influencer d'autres manières."

# game/adine1.rpy:292
translate frenchtl _call_skipcheck_10_9fafc86f:

    # Ad "Even something as simple as this dish? I like that idea."
    Ad "Même quelque chose d'aussi simple que ce plat ? J'aime cette idée."

# game/adine1.rpy:299
translate frenchtl _call_skipcheck_10_24fbdd31:

    # Ad "I thought you just did."
    Ad "Je pensais simplement que ça t'intéressait."
...
translate frenchtl _call_skipcheck_10_6ab075ea:
    ...
    c "Tu es plus un parent d'accueil, alors ?"
...
translate frenchtl _call_skipcheck_10_4252207b:
    ...
    Ad "Pas tout à fait. Ce sont de jeunes orphelins dont je parle. Je passe bénévolement du temps avec eux, alors je suis plus comme une babysitter et une enseignante, tout à la fois."
...
translate frenchtl _call_skipcheck_10_6dae616b:
    ...
    Ad "Avec la quantité de temps que je passe au restaurant, je ne pense pas que les enfants seraient mieux, alors j'aide simplement quand je le peux."

# game/adine1.rpy:311
translate frenchtl _call_skipcheck_10_8a56387f:

    # c "That's very nice of you."
    c "C'est très gentil de ta part."
...
translate frenchtl _call_skipcheck_10_d29d4197:
    ...
    c "Je vois. Et les passe-temps ? En as-tu ?"

# game/adine1.rpy:318
translate frenchtl _call_skipcheck_10_ebf1fe4b:

    # Ad "Can I ask a question for a change?"
    Ad "Est-ce que je peux te poser une question pour changer ?"
...
translate frenchtl _call_skipcheck_10_75906cf7:
    ...
    Ad "Eh bien, je ne sais pas grand chose sur toi. En fait, je pense que c'est le cas de tout le monde ici."

# game/adine1.rpy:339
translate frenchtl _call_skipcheck_10_41444a40:

    # c "What would you like to know?"
    c "Que voudrais-tu savoir ?"
...
translate frenchtl _call_skipcheck_10_52e199a5:
    ...
    c "Rien de spécial, vraiment. Je veux dire, j'ai mes diplômes, mais c'est la première fois que que je fais quelque chose en lien avec eux. Le travail que je faisais auparavant me permettait juste de garder la tête hors de l'eau."

# game/adine1.rpy:348
translate frenchtl _call_skipcheck_10_4b7f20ab:

    # Ad "I know what you mean."
    Ad "Je comprends tout à fait."
...
translate frenchtl _call_skipcheck_10_0cc7643e:
    ...
    c "Je suppose que c'est de nouveau mon tour, alors parle-moi de tes loisirs."

# game/adine1.rpy:367
translate frenchtl _call_skipcheck_10_cc546db3:

    # Ad "The one I enjoy most is probably flying."
    Ad "Celui que j'aime le plus est probablement voler."
...
translate frenchtl _call_skipcheck_10_4b4db401:
    ...
    Ad "Bah, pas {i}simplement{/i} voler."
...
translate frenchtl _call_skipcheck_10_43ec0d7d:
    ...
    Ad "Je fais de la voltige. Cela fait quelques années que j'en fait ici et là."

# game/adine1.rpy:379
translate frenchtl _call_skipcheck_10_f106bf6f:

    # Ad "Actually, that might not be so far from the truth."
    Ad "En fait, ça ne doit pas être si loin de la vérité."
...
translate frenchtl _call_skipcheck_10_3a15203a:
    ...
    Ad "Je suppose que cela dépend de si tu seras encore là ou pas quand elle aura lieu. Elle fait partie du festival qui se tient chaque année dans cette ville."

# game/adine1.rpy:409
translate frenchtl _call_skipcheck_10_410ee6b4:

    # Ad "Okay, since it is my turn again, well..."
    Ad "Bon, puisque c'est mon tour encore, eh bien..."
...
translate frenchtl _call_skipcheck_10_9fd77ad2:
    ...
    Ad "Pour être honnête, je ne sais pas si c'est si c'est une si bonne idée de généraliser de cette manière - même si ce sont des bonnes choses que vous dites sur nous. Nous sommes tous différents, tu sais, et ce n'est pas tout le monde qui est gentil."
...
translate frenchtl _call_skipcheck_10_27b32db1:
    ...
    Ad "Tu vois, découvrir qu'une chose dont tu n'as jamais entendu parlé que dans des histoires est, en fait, réel est assez spécial."
...
translate frenchtl _call_skipcheck_10_aaa0f5f8:
    ...
    c "Je n'étais pas certain de quoi penser. En tout cas, jusqu'à ce que j'arrive ici et que je me tienne en face de l'un d'entre vous. Cela m'a rendu sans voix."
...
translate frenchtl _call_skipcheck_10_9cf84c2e:
    ...
    c "Je pensais qu'une découverte comme celle-ci était juste géniale. Beaucoup de gens aurait adoré avoir l'opportunité que j'ai eu en venant ici."
...
translate frenchtl _call_skipcheck_10_827a62d3:
    ...
    c "Et ce n'est pas juste la découverte des dragons. On a trouvé un portail vers un monde complètement différent. On ne l'a toujours pas encore compris celle-là."
...
translate frenchtl _call_skipcheck_10_5479d226:
    ...
    c "Je suis sur qu'on va le découvrir assez tôt."
...
translate frenchtl _call_skipcheck_10_26e8f868:
    ...
    Ad "\"Rien de spécial\" est une bonne manière de décrire la série toute entière, en fait."
...
translate frenchtl _call_skipcheck_10_089aa707:
    ...
    Ad "C'est plus qu'un livre. Bien que, je suppose que ce n'est peut être pas si important pour quelqu'un qui ne vit pas ici."
...
translate frenchtl _call_skipcheck_10_98d1aad3:
    ...
    Ad "Fais-moi savoir quand tu l'as lu. Je serais intéressé d'entendre ce que tu as à dire dessus."
...
translate frenchtl _call_skipcheck_10_9e9eaf83:
    ...
    Ad "D'accord, comme tu as demandé à propos de ma famille plus tôt, je vais faire la même chose. Y a-t-il un monsieur ou madame [player_name] qui t'attend chez toi ?"

# game/adine1.rpy:582
translate frenchtl _call_skipcheck_10_a26d4342:

    # c "No, can't say there is."
    c "Non, c'est pas vraiment le cas."
...
translate frenchtl _call_skipcheck_10_d16f87c9:
    ...
    Ad "Que dis-tu d'un monsieur ou madame [player_name] potentiel alors ? Cherches-tu à sortir avec quelqu'un ?"
...
translate frenchtl _call_skipcheck_10_75d20bbd:
    ...
    Ad "Je vois. N'importe qui dans ton radar ? Quelqu'un que tu trouves attirant ?"

# game/adine1.rpy:602
translate frenchtl _call_skipcheck_10_6b0e1c03:

    # Ad "Oh, it's a shame you can't be with them now, then."
    Ad "Oh, c'est dommage que tu ne puisses pas être avec eux."
...
translate frenchtl choicec_41d17e99:
    ...
    Ad "Serait-ce quelqu'un que je connais ?"
...
translate frenchtl choicec_9e4b6bcd:
    ...
    Ad "Personne par ici n'a attiré ton attention ?"
...
translate frenchtl nextsc_bf87ec10:
    ...
    Ad "Je ne sais même pas quel genre de défi je pourrais te faire faire."
...
translate frenchtl nextsc_206795eb:
    ...
    c "Eh bien, rappelles-toi que la revanche peut venir plus vite que tu le penses, alors ne demande pas à quelqu'un de faire quelque chose que tu ne feras pas toi-même."
...
translate frenchtl nextsc_24285aa7:
    ...
    c "Tu as posé les dernières questions, alors ce serait équitable si je commence."
...
translate frenchtl nextsc_6c279b9e:
    ...
    Ad "Tu n'abuserais pas de cette information, n'est-ce pas?"
...
translate frenchtl nextsc_f0510f43:
    ...
    Ad "Il avait eut cette fois lorsque j'étais encore une adolescente. Je m'amusais et je voulais essayer une nouvelle manœuvre de vol: un tonneau. Pas besoin de te dire que ça s'est mal fini."

# game/adine1.rpy:776
translate frenchtl nextsc_b917eced:

    # c "I guess you didn't succeed, then?"
    c "J'imagine que tu n'as pas réussi, du coup ?"
...
translate frenchtl nextsc_895e7591:
    ...
    Ad "Non, le tonneau en lui même s'est bien passé, mais j'ai perdu contrôle après ça et me suis vautrée par terre."

# game/adine1.rpy:778
translate frenchtl nextsc_b2517d74:

    # c "Oh, were you hurt?"
    c "Oh, tu t'es blessée ?"
...
translate frenchtl nextsc_54608f68:
    ...
    Ad "Non, heureusement je n'étais pas trop haute lorsque je l'ai fait, et il y avait une flaque de boue là où j'ai atterri. Bien sûr tous mes amis étaient là pour le voir."

# game/adine1.rpy:781
translate frenchtl nextsc_57d8dcd9:

    # c "That wasn't enough to stop you from ever trying again?"
    c "Ce n'était pas assez pour te dissuader de réessayer ?"

# game/adine1.rpy:783
translate frenchtl nextsc_818b4ba1:

    # Ad "No. If anything, it only made me want to try harder."
    Ad "Non. Si ça a fait quelque chose, c'est seulement de me donner l'envie d'essayer encore plus."

# game/adine1.rpy:785
translate frenchtl nextsc_1b02c93b:

    # Ad "Since it is my turn now: What is your greatest wish?"
    Ad "Puisque c'est mon tour maintenant : quel est ton vœu le plus cher ?"

# game/adine1.rpy:790
translate frenchtl nextsc_c00b79d5:

    # c "More than anything, I'd want there to be peace on Earth."
    c "Plus que tout au monde, je voudrais la paix sur Terre."

# game/adine1.rpy:791
translate frenchtl nextsc_24edf6f0:

    # Ad "That is an honorable wish, [player_name]."
    Ad "C'est un vœu honorable, [player_name]."
...
translate frenchtl nextsc_de415d5c:
    ...
    c "Être riche et avoir la liberté de faire ce que je veux, quand je veux."
...
translate frenchtl nextsc_5b659cad:
    ...
    c "Bien, avec cette question c'est plutôt à propos de qu'est-ce que tu vas faire si tu as l'opportunité de faire quelque chose sans te faire attraper, comme quelque chose de malicieux ou criminel."
...
translate frenchtl nextsc_d89cde73:
    ...
    Ad "Oh, je sais ce que je ferais. J'explorerais le bâtiment qu'ils ont trouvé avec le portail."
...
translate frenchtl nextsc_a70918ca:
    ...
    Ad "Tu n'en as pas entendu parler ? Ils ont trouvé tout un bâtiment avec le portail."
...
translate frenchtl nextsc_e950f342:
    ...
    Ad "C'est sous terre en fait, et ils l'ont mis sous haute garde pendant qu'une équipe d'archéologues y travaille. Je pense qu'il pourrait contenir beaucoup de secrets et de réponses à propos du portail et d'où il vient."

# game/adine1.rpy:827
translate frenchtl nextsc_81939529:

    # c "Interesting. I think I'd like to check that out as well."
    c "Intéressant. Je pense que j'aimerais bien aller y jeter un œil également."

# game/adine1.rpy:830
translate frenchtl nextsc_e306f303:

    # Ad "No, absolutely not."
    Ad "Non, absolument pas."
...
translate frenchtl nextsc_6507f194:
    ...
    Ad "Eh bien, j'ai quelques idées de ce qui pourrait se passer après coup, mais même si ce que je pense n'est pas vrai, je n'ai pas peur de l'inconnu."
...
translate frenchtl nextsc_c1901d4d:
    ...
    Ad "Aussi tordu que ça puisse paraître, je suis en fait plutôt curieuse de découvrir à quoi ça ressemblera quand tout sera fini."

# game/adine1.rpy:840
translate frenchtl nextsc_dace38e7:

    # Ad "Aren't you curious as well?"
    Ad "N'es-tu pas curieux toi aussi ?"
...
translate frenchtl nextsc_da6029a2:
    ...
    Ad "Ce n'est pas drôle, [player_name]."
...
translate frenchtl nextsc_e3afd84b:
    ...
    Ad "C'est une question très difficile tu sais."
...
translate frenchtl nextsc_a77509ab:
    ...
    Ad "Je crois que c'est le moment pour une action maintenant."
...
translate frenchtl nextsc_0268ca80:
    ...
    Ad "Juste ça ? Ce n'est pas très difficile."

# game/adine1.rpy:943
translate frenchtl nextsc_dc9a1cef:

    # c "I thought I'd go easy on you, since it is your first time and all."
    c "Je pensais y aller doucement, comme c'est ta première fois et tout."
...
translate frenchtl _call_syscheck_48_38babdee:
    ...
    c "Tu peux en trouver un dans le panier à fruit."
...
translate frenchtl _call_syscheck_48_e78a619c:
    ...
    Ad "Alors, je devrais juste prendre une bouchée de celui-là ?"

# game/adine1.rpy:1016
translate frenchtl _call_syscheck_48_d88b5013:

    # c "That's your dare."
    c "C'est ça ton action."
...
translate frenchtl _call_syscheck_48_30f9f005:
    ...
    Ad "Eh bien, ma réponse serait non alors. Je n'embrasse pas n'importe qui, tu sais."
...
translate frenchtl _call_syscheck_48_5eb2273d:
    ...
    Ad "Toutefois, si c'était une action, ma réponse serait peut être différente."
...
translate frenchtl _call_syscheck_48_b1f9f1ed:
    ...
    Ad "Bien, alors de ceux que tu as rencontré ici jusqu'à maintenant, qui est la personne qui t'attire le plus ?"

# game/adine1.rpy:1196
translate frenchtl _call_syscheck_48_ad7dc334:

    # c "I think I'll take a dare for this one."
    c "Je pense que je vais prendre une action pour celui-là."
...
translate frenchtl _call_syscheck_48_f69997a6:
    ...
    Ad "Hmm, qu'est-ce que je pourrais te faire faire ?"
...
translate frenchtl _call_syscheck_48_bd0be8be:
    ...
    Ad "Non, je n'ai honnêtement aucune idée."
...
translate frenchtl _call_syscheck_48_9b53a99d:
    ...
    n "Elle partit aussi vite qu'elle fut apparue, mais étant donné son enthousiasme, je doutais que ce soit la dernière fois que j'allais entendre parler d'elle."
...
translate frenchtl adine1skip_ce4f72ae:
    ...
    Ad "Écoute, je ne veux pas être grossière, mais je pense que ce serait mieux si on ne se revoyait pas. Désolée !"

translate frenchtl strings:

    # adine1.rpy:10
    old "Chapter 4 - Adine 1"
    new "Chapitre 4 - Adine 1"

    # adine1.rpy:14
    old "Chapter 3 - Adine 1"
    new "Chapitre 3 - Adine 1"

    # adine1.rpy:18
    old "Chapter 2 - Adine 1"
    new "Chapitre 2 - Adine 1"

    # adine1.rpy:22
    old "Chapter 1 - Adine 1"
    new "Chapitre 1 - Adine 1"
    ...
    new "Que t'est-il arrivé, tu es tombée dans une rivière ou quoi ?"
    ...
    new "Je suppose que ça ne fera pas de mal si tu viens quelques minutes."
    ...
    new "Peut-être que je m'en fiche."
    ...
    new "[[Éviter la question en faisant un mauvais jeu de mot.]"

    # adine1.rpy:343
    old "That's classified."
    new "C'est secret défense."

    # adine1.rpy:374
    old "You must be the most overqualified delivery flyer in history, then."
    new "Tu dois être la livreuse aérienne la plus surqualifiée de l'histoire alors."

    # adine1.rpy:374
    old "That's a cool, but also pretty useless hobby."
    new "C'est un loisir sympa, mais assez inutile aussi."
    ...
    new "Alors tu peux faire tout ca, mais un peu de pluie c'est trop pour toi ?"

    # adine1.rpy:394
    old "Are you that good?"
    new "Es-tu si compétente ?"

    # adine1.rpy:394
    old "Awesome, where can I watch that?"
    new "Génial, où est-ce que je peux regarder ça ?"

    # adine1.rpy:413
    old "That's not really a question."
    new "Ce n'est pas vraiment une question."
    ...
    new "C'était amusant, mais rien de spécial."
    ...
    new "Ce n'était pas vraiment mon truc."

    # adine1.rpy:563
    old "I'm not sure if it's my kind of book."
    new "Je ne sais pas si c'est mon genre de livre."
    ...
    new "C'est difficile pour moi de trouver du temps pour lire ces temps-ci."
    ...
    new "Ce ne sont pas tes affaires."
    ...
    new "Bon d'accord, il y a quelqu'un."

    # adine1.rpy:634
    old "Well, there's someone."
    new "Eh bien, il y a quelqu'un."

    # adine1.rpy:703
    old "Well, you started it."
    new "Eh bien, c'est toi qui a commencé."

    # adine1.rpy:703
    old "Just having fun."
    new "Juste pour s'amuser."

    # adine1.rpy:703
    old "Sorry, you gotta play by the rules."
    new "Désolé, tu dois jouer selon les règles."

    # adine1.rpy:748
    old "Which part of your body is the most ticklish?"
    new "Quel partie de ton corps est la plus chatouilleuse ?"

    # adine1.rpy:748
    old "What is your most guarded secret?"
    new "Quel est ton secret le mieux gardé ?"

    # adine1.rpy:748
    old "What's the most embarrassing thing that ever happened to you?"
    new "Quel est la chose la plus embarrassante qui te soit arrivée ?"

    # adine1.rpy:787
    old "World peace."
    new "La paix dans le monde."

    # adine1.rpy:787
    old "Be the very best, like no one ever was."
    new "Être le meilleur, et gagner les défis."
    ...
    new "Que ferais-tu si tu étais invisible pour une journée ?"

    # adine1.rpy:814
    old "Are you scared of dying?"
    new "As-tu peur de mourir ?"

    # adine1.rpy:814
    old "What do you think is your biggest physical flaw?"
    new "Qu'est ce que tu penses être ta plus grosse imperfection physique ?"
    ...
    new "Tu sais, si tu es si pressée de savoir, je peux t'aider avec ça."

    # adine1.rpy:863
    old "I think they're cute."
    new "Je pense qu'elles sont adorables."

    # adine1.rpy:863
    old "I agree with you there."
    new "Je suis d'accord avec toi."

    # adine1.rpy:863
    old "I'm not sure I'd agree with that."
    new "Je ne sais pas si je suis d'accord avec toi."

    # adine1.rpy:880
    old "Enjoy life to the fullest until the last moment."
    new "Profiter de la vie jusqu'au dernier moment."
    ...
    new "Rester dehors et regarder le tout se dérouler sous mes yeux."

    # adine1.rpy:880
    old "Hide in a bunker deep underground."
    new "Me cacher dans un abri loin sous terre."

    # adine1.rpy:923
    old "If you could come back with me to my world right now, would you do it?"
    new "Si tu pouvais venir avec moi dans mon monde maintenant, le ferais-tu ?"

    # adine1.rpy:923
    old "What's your biggest regret?"
    new "Quel est ton plus gros regret ?"

    # adine1.rpy:923
    old "If I asked you to kiss me, would you do it?"
    new "Si je te demande de m'embrasser, le ferais-tu ?"

    # adine1.rpy:937
    old "Remove your headgear."
    new "Enlève tes lunettes."
