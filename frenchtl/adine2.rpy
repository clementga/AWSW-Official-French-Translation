...
translate frenchtl adine2_7ccf0895:
    ...
    c "Ouais, je ne savais pas combien de temps ça m'aurait pris pour me rendre ici. Mieux vaut tôt que tard, pas vrai ?"

# game/adine2.rpy:53
translate frenchtl adine2_92e83d0b:
...
# game/adine2.rpy:55
translate frenchtl adine2_e0224be1:

    # c "Me too."
    c "Moi aussi."

# game/adine2.rpy:73
translate frenchtl adine2_395ada7a:

    # c "And who might that be?"
    c "Oh, et qui ça peut bien être ?"

# game/adine2.rpy:75
translate frenchtl adine2_4e31e593:

    # Ad "This is Amely. She's one of the kids I work with."
    Ad "C'est Amely. C'est l'une des enfants avec qui je travaille."

# game/adine2.rpy:83
translate frenchtl adine2_8ca98933:

    # c "Hello, Amely."
    c "Bonjour, Amely."

# game/adine2.rpy:85
translate frenchtl adine2_563b937f:

    # Ad "Say hi, Amely."
    Ad "Dit bonjour, Amely."

# game/adine2.rpy:87
translate frenchtl adine2_880895e8:
...
# game/adine2.rpy:110
translate frenchtl adine2_5d1a3880:

    # s "You met Amely! {image=image/ui/status/c2pictures.png}"
    s "Tu as rencontré Amely ! {image=image/ui/status/c2pictures.png}"

# game/adine2.rpy:136
translate frenchtl _call_skiptut_23_44e0ddc6:
...
# game/adine2.rpy:144
translate frenchtl _call_skiptut_23_690da0b1:

    # s "It looks like you've seen this before. Skip ahead a bit?"
    s "On dirait que vous avez déjà vu cela auparavant. Avancer un peu ?"

# game/adine2.rpy:152
translate frenchtl _call_skiptut_23_889f24a0:
...
# game/adine2.rpy:166
translate frenchtl _call_skiptut_23_0054b77b:

    # s "As you wish.{cps=2}..{/cps}{w=1.0}{nw}"
    s "Comme vous voulez.{cps=2}..{/cps}{w=1.0}{nw}"

# game/adine2.rpy:189
translate frenchtl _call_skipcheck_23_0054b77b:
...
# game/adine2.rpy:199
translate frenchtl _call_skipcheck_23_4bab5848:
...
translate frenchtl _call_skipcheck_23_8c00b781:
    ...
    c "Attends, tu l'as ramené en volant ?"

# game/adine2.rpy:205
translate frenchtl _call_skipcheck_23_f3e453e6:

    # Ad normal b "Well, I am a delivery flyer."
    Ad normal b "Eh bien, je suis une livreuse aviaire."

# game/adine2.rpy:207
translate frenchtl _call_skipcheck_23_1caf3f1f:

    # c "She doesn't get scared or anything?"
    c "Elle n'a pas eu peur ou quoi que ce soit ?"

# game/adine2.rpy:209
translate frenchtl _call_skipcheck_23_4d017343:

    # Ad "Not at all. She's such a brave little girl."
    Ad "Pas du tout. C'est une petite fille très courageuse."
...
translate frenchtl _call_skipcheck_23_a459ddc5:
    ...
    Ad "Je suis bénévole. Je les aide pour tout ce dont ils ont besoin, et je m'occupe parfois des enfants."

# game/adine2.rpy:215
translate frenchtl _call_skipcheck_23_48373b94:
    ...
    Ad "Ils ont très peu de travailleurs sociaux. La proportion est d'environ un travailleur social pour 10 enfants, alors c'est bon pour les enfants d'avoir du temps seul à seul avec quelqu'un qu'ils connaissent."
...
translate frenchtl _call_skipcheck_23_10c192ff:
    ...
    c "Elle a l'air d'une sale gosse agaçante. Je ne voudrais certainement pas laisser l'un d'entre eux chez moi."

# game/adine2.rpy:236
translate frenchtl _call_skipcheck_23_d7e70092:

    # Ad disappoint b "How can you say that?"
    Ad disappoint b "Comment peux-tu dire ça ?"

# game/adine2.rpy:238
translate frenchtl _call_skipcheck_23_2b09d0f0:

    # c "I'm just being honest."
    c "Je suis juste honnête."

# game/adine2.rpy:240
translate frenchtl _call_skipcheck_23_81fedecd:

    # Ad annoyed b "You know, sometimes, honesty is not the best policy."
    Ad annoyed b "Tu sais, parfois, l'honnêteté n'est pas la meilleure approche."

# game/adine2.rpy:242
translate frenchtl _call_skipcheck_23_a1107f7d:

    # Ad disappoint b "Someone has to look out for her."
    Ad disappoint b "Quelqu'un doit veiller sur elle."

# game/adine2.rpy:248
translate frenchtl _call_skipcheck_23_a41c499d:

    # Ad "I'm afraid it's just not that easy, and the actual numbers of adoptions aren't very promising, either."
    Ad "J'ai peur que ça ne soit pas aussi simple, et les taux nombres d'adoptions ne sont pas très prometteurs non plus."

# game/adine2.rpy:251
translate frenchtl _call_skipcheck_23_5743cfb2:

    # Ad "I'm worried about what will happen to her if she doesn't find a family."
    Ad "Je m'inquiète de ce qui va lui arriver si elle ne trouve pas une famille."

# game/adine2.rpy:253
translate frenchtl _call_skipcheck_23_8416514a:

    # Ad "We will still take care of her, of course, but it's not quite the same as having parents."
    Ad "On s'occupera toujours d'elle, bien sûr, mais ce n'est pas vraiment la même chose que d'avoir des parents."
...
translate frenchtl _call_skipcheck_23_434e0470:
    ...
    Ad "Je me porte volontaire aussi souvent que possible, parce que si je ne le fais pas, qui le fera? Quelqu'un se doit d'être là pour ces enfants."
...
translate frenchtl _call_skipcheck_23_8dd99f8a:
    ...
    Ad disappoint b "Oh, je viens de me souvenir que quelqu'un est mort ici récemment."

# game/adine2.rpy:293
translate frenchtl _call_skipcheck_23_4c037c2d:

    # c "Here, in your apartment?"
    c "Ici, dans ton appartement ?"
...
translate frenchtl _call_skipcheck_23_6645a410:
    ...
    c "C'est ça, le meurtre du gars de maintenance. Je me rappelle de ça."
...
translate frenchtl _call_skipcheck_23_deaa0d16:
    ...
    c "Désolé de mettre ça sur la table."
...
translate frenchtl _call_skipcheck_23_0b322fb0:
    ...
    Ad think b "C'est une façon étrange de voir ça, mais tu marques un point."
...
translate frenchtl _call_skipcheck_23_89403437:
    ...
    c "Ne t'attarde pas sur le négatif. Ça ne sert à rien de se lamenter sur quelque chose que tu ne peux pas changer."

# game/adine2.rpy:329
translate frenchtl _call_skipcheck_23_fa4cb7ce:

    # Ad "Sorry, [player_name]. I guess I should be more positive."
    Ad "Désolé, [player_name]. J'imagine que je devrais être plus positive."

# game/adine2.rpy:331
translate frenchtl _call_skipcheck_23_dbdb04e5:

    # Ad "It's just not always easy, you know."
    Ad "Ce n'est pas toujours facile, tu sais."
...
translate frenchtl _call_skipcheck_23_baf080e5:
    ...
    Ad normal b "J'espère."

# game/adine2.rpy:342
translate frenchtl _call_skipcheck_23_6caae3ba:

    # Ad "That reminds me, I've got something I wanted to try on you."
    Ad "Maintenant que j'y pense, il y a quelque chose que je veux te faire essayer."

# game/adine2.rpy:344
translate frenchtl _call_skipcheck_23_b86d6667:

    # c "Try on me?"
    c "Me faire essayer ?"

# game/adine2.rpy:346
translate frenchtl _call_skipcheck_23_72a69e39:
...
# game/adine2.rpy:352
translate frenchtl _call_skipcheck_23_661a9853:
...
# game/adine2.rpy:358
translate frenchtl _call_skipcheck_23_13ba6e80:

    # Ad "Isn't that the whole fun of it?"
    Ad "N'est-ce pas ce qui est le plus amusant avec ça ?"

# game/adine2.rpy:369
translate frenchtl _call_skipcheck_23_e2c3a930:

    # Ad annoyed b "Come on, don't knock it before you try it."
    Ad annoyed b "Allez, ne critique pas avant d'avoir essayé."

# game/adine2.rpy:378
translate frenchtl _call_skipcheck_23_3d537ac6:

    # c "With articles like {i}5 Steps to Get the Partner of Your Dreams{/i}, I'm sure they're qualified to determine my fate."
    c "Avec des articles comme {i}5 Étapes pour Avoir le Partenaire de Tes Rêves{/i}, je suis certain qu'ils sont qualifiés pour déterminer mon destin."

# game/adine2.rpy:380
translate frenchtl _call_skipcheck_23_840cdea4:

    # Ad normal b "Come on, it'll be fun."
    Ad normal b "Allez, ça va être amusant."

# game/adine2.rpy:382
translate frenchtl _call_skipcheck_23_8fc66374:

    # c "If you say so."
    c "Si tu le dis."

# game/adine2.rpy:384
translate frenchtl _call_skipcheck_23_fc66ae05:

    # Ad "What should we look at first?"
    Ad "Qu'est ce qu'on devrait regarder en premier ?"

# game/adine2.rpy:392
translate frenchtl _call_skipcheck_23_27216165:

    # Ad think b "Alright, let's see."
    Ad think b "Bien, voyons voir."

# game/adine2.rpy:399
translate frenchtl _call_skipcheck_23_27216165_1:

    # Ad think b "Alright, let's see."
    Ad think b "Bien, voyons voir."

# game/adine2.rpy:408
translate frenchtl _call_skipcheck_23_99b68283:

    # Ad annoyed b "That's very funny, [player_name]."
    Ad annoyed b "C'est très drôle, [player_name]."

# game/adine2.rpy:415
translate frenchtl _call_skipcheck_23_387b6fd4:
...
# game/adine2.rpy:417
translate frenchtl _call_skipcheck_23_19f1eadc:

    # Ad think b "Have you had any strange or recurring dreams lately?"
    Ad think b "As-tu eu des rêves étrange ou récurrent dernièrement ?"

# game/adine2.rpy:425
translate frenchtl _call_skipcheck_23_c029577a:

    # Ad normal b "Well, according to this article, that means you're a really creative person."
    Ad normal b "Eh bien, d'après cet article, ça veut dire que tu es une personne très créative."

# game/adine2.rpy:427
translate frenchtl _call_skipcheck_23_4e50fccb:
...
# game/adine2.rpy:444
translate frenchtl _call_skipcheck_23_f62f1fb5:

    # Ad think b "Phew."
    Ad think b "Fiou."

# game/adine2.rpy:455
translate frenchtl _call_skipcheck_23_52128d22:

    # Ad normal b "Actually, that's not the case. You only think that because you don't remember your dreams."
    Ad normal b "En fait, ce n'est pas le cas. Tu penses ça simplement parce que tu ne te rappelles pas de tes rêves."

# game/adine2.rpy:457
translate frenchtl _call_skipcheck_23_584b119a:

    # Ad think b "But even that can tell us something."
    Ad think b "Mais même ça peut nous dire quelque chose."

# game/adine2.rpy:459
translate frenchtl _call_skipcheck_23_a6521f18:
...
# game/adine2.rpy:461
translate frenchtl _call_skipcheck_23_25c73dcb:
    ...
    Ad normal b "Les dormeurs légers se rapelle plus souvent de leurs rêves, particulièrement s'ils se réveillent pendant la nuit. Il paraît que se rappeler de son rêve a une forte corrélation au fait de se réveiller pendant la bonne phase du sommeil."
...
translate frenchtl _call_skipcheck_23_5ed4401f:
    ...
    Ad normal b "Mais pour un rêve récurrent qui implique la même personne c'est une autre histoire. Ça peut représenter des émotions fortes pour cette personne ou des problèmes qui ne sont pas résolus avec elle."

# game/adine2.rpy:475
translate frenchtl _call_skipcheck_23_3761077d:
...
# game/adine2.rpy:487
translate frenchtl _call_skipcheck_23_0b16a848:
...
translate frenchtl _call_skipcheck_23_a3230f03:
    ...
    Ad think b "Je dis juste qu'il doit y avoir une raison à leur existence. Même l'article conclut que les scientifiques n'ont pas encore trouvé exactement pourquoi nous rêvons. C'est un grand mystère."

# game/adine2.rpy:498
translate frenchtl _call_skipcheck_23_573eac2e:

    # Ad "Even the article concludes that scientists haven't figured out exactly why we dream. It's a big mystery."
    Ad "Même l'article conclut que les scientifiques n'ont pas encore trouvé exactement pourquoi nous rêvons. C'est un grand mystère."

# game/adine2.rpy:501
translate frenchtl _call_skipcheck_23_604e3357:

    # Ad normal b "Alright, let's move on."
    Ad normal b "D'accord, changeons de sujet."

# game/adine2.rpy:505
translate frenchtl _call_skipcheck_23_dc53aaac:

    # c "Oh, I thought you meant moving on from the magazine."
    c "Oh, je pensais que tu voulais dire en finir avec le magazine."

# game/adine2.rpy:507
translate frenchtl _call_skipcheck_23_3cbb554a:
...
# game/adine2.rpy:515
translate frenchtl _call_skipcheck_23_bf8eb063:

    # Ad think b "That's probably for the best."
    Ad think b "C'est probablement pour le mieux."

# game/adine2.rpy:522
translate frenchtl _call_skipcheck_23_6c53fdda:
...
# game/adine2.rpy:538
translate frenchtl _call_skipcheck_23_02405e38:

    # Ad normal b "A personality test. Didn't you always want to know what kind of relationship would suit you?"
    Ad normal b "Un test de personnalité. Ne veux-tu pas savoir quel genre de relation te conviendrait le mieux ?"

# game/adine2.rpy:546
translate frenchtl _call_skipcheck_23_bc0d17cb:
...
# game/adine2.rpy:577
translate frenchtl _call_skipcheck_23_37243f64:

    # Ad giggle b "Is that so?"
    Ad giggle b "c'est vrai ?"

# game/adine2.rpy:591
translate frenchtl _call_skipcheck_23_d48bec38:
...
# game/adine2.rpy:606
translate frenchtl _call_skipcheck_23_cf5c043d:

    # Ad "Variety is the spice of life, right?"
    Ad "Varier met du piment dans la vie, pas vrai ?"

# game/adine2.rpy:609
translate frenchtl _call_skipcheck_23_f2387144:

    # Ad "Moving on to the next question."
    Ad "Passons à la prochaine question."

# game/adine2.rpy:611
translate frenchtl _call_skipcheck_23_2ee186bd:

    # c "Wait, aren't you going to answer the questions, too?"
    c "Attends, tu ne vas pas répondre aux questions, aussi ?"

# game/adine2.rpy:613
translate frenchtl _call_skipcheck_23_6e464236:

    # Ad "I'll take the test after you. I don't want to keep track of both our scores at once."
    Ad "Je passerai le test après toi. Je ne veux pas avoir à retenir nos deux scores en même temps."

# game/adine2.rpy:615
translate frenchtl _call_skipcheck_23_86148265:

    # c "Alright."
    c "D'accord."

# game/adine2.rpy:617
translate frenchtl _call_skipcheck_23_c7f796d3:

    # Ad "Question number two: What is your favorite dessert?"
    Ad "Question numéro deux: Quel est ton dessert préféré ?"

# game/adine2.rpy:627
translate frenchtl adine2menb_508cb881:

    # Ad "An all-time classic. Who doesn't like chocolate cake?"
    Ad "Un classique. Qui n'aime pas le gâteau au chocolat ?"
...
# game/adine2.rpy:700
translate frenchtl adine2menb_dd089063:

    # Ad giggle b "Forget I said anything."
    Ad giggle b "Oublie ce que j'ai dit."

# game/adine2.rpy:709
translate frenchtl adine2menb_a239277e:

    # c "How many more questions are there?"
    c "Il reste combien de questions ?"

# game/adine2.rpy:711
translate frenchtl adine2menb_4e2e790b:

    # Ad giggle b "That's all of them."
    Ad giggle b "C'est tout."

# game/adine2.rpy:713
translate frenchtl adine2menb_d653223e:
...
# game/adine2.rpy:729
translate frenchtl adine2menb_9f85b645:

    # c "Yeah."
    c "Ouais."

# game/adine2.rpy:731
translate frenchtl adine2menb_3a48fa0a:

    # Ad disappoint b "Oh, well."
    Ad disappoint b "Tant pis."

# game/adine2.rpy:740
translate frenchtl adine2menb_634302e3:

    # Ad disappoint b "Yeah, I really wanted to know."
    Ad disappoint b "Ouais, je voulais vraiment savoir."

# game/adine2.rpy:747
translate frenchtl adine2menb_59cf7678:
...
# game/adine2.rpy:761
translate frenchtl adine2menb_bbcd79f2:

    # Ad disappoint b "Come on, what's the worst that could happen?"
    Ad disappoint b "Allons, qu'est-ce qui peut t'arriver au pire ?"

# game/adine2.rpy:763
translate frenchtl adine2menb_b1304934:

    # c "I could waste precious minutes of my life that I'm never going to get back."
    c "Je pourrais gaspiller de précieuses minutes de ma vie que je ne pourrai jamais rattraper."

# game/adine2.rpy:765
translate frenchtl adine2menb_fe3290e5:

    # Ad normal b "Haha. Very funny."
    Ad normal b "Haha. Très drôle."

# game/adine2.rpy:772
translate frenchtl adine2menb_8bd50539:
...
# game/adine2.rpy:781
translate frenchtl adine2menb_f74971f2:

    # Ad normal b "Me too."
    Ad normal b "Moi aussi."

# game/adine2.rpy:786
translate frenchtl adine2menb_c6638b47:
...
# game/adine2.rpy:794
translate frenchtl adine2menb_de46ac95:

    # c "But where, though?"
    c "Mais d'où ?"

# game/adine2.rpy:796
translate frenchtl adine2menb_d9442b37:

    # Ad think b "Well, one interpretation is that it's our subconscious who gives us the answers that we seek."
    Ad think b "Eh bien, une interprétation est que c'est notre subconscient qui nous donne les réponses que nous cherchons."
...
translate frenchtl adine2menb_9281ee4a:
    ...
    Ad think b "Mais ça, c'est juste l'interprétation la plus basique en vogue. D'habitude les gens associent les cartes de divination à quelque chose de plus paranormal."

# game/adine2.rpy:804
translate frenchtl adine2menb_8cb2b508:
...
# game/adine2.rpy:806
translate frenchtl adine2menb_f930bbb0:

    # c "And who would that be?"
    c "Et ce serait qui ?"

# game/adine2.rpy:808
translate frenchtl adine2menb_26af2b97:

    # Ad giggle b "The explanations range from ghosts to angelic beings. One even involved humans."
    Ad giggle b "Les explications vont des fantômes jusqu'aux entités angéliques. L'une d'entre elles impliquait même des humains."

# game/adine2.rpy:810
translate frenchtl adine2menb_4e24c2ca:

    # c "Really?"
    c "Vraiment ?"

# game/adine2.rpy:812
translate frenchtl adine2menb_a793f8f2:
...
# game/adine2.rpy:814
translate frenchtl adine2menb_624b970f:
...
# game/adine2.rpy:816
translate frenchtl adine2menb_79f4e854:

    # c "Higher self?"
    c "Le sur moi ?"

# game/adine2.rpy:818
translate frenchtl adine2menb_a25761a6:

    # c "How come you know so much about this?"
    c "Comment sais-tu tout ça ?"

# game/adine2.rpy:820
translate frenchtl adine2menb_b99621a1:

    # Ad normal b "Because I read the article about it."
    Ad normal b "Parce que j'ai lu l'article à ce sujet."

# game/adine2.rpy:822
translate frenchtl adine2menb_4bcb453b:
...
# game/adine2.rpy:828
translate frenchtl adine2menb_e93f73d0:
...
# game/adine2.rpy:830
translate frenchtl adine2menb_fe5f3366:

    # c "Okay."
    c "Ok."

# game/adine2.rpy:832
translate frenchtl adine2menb_94e2962e:

    # c "So, what are my options?"
    c "Donc, quelles sont mes options ?"

# game/adine2.rpy:834
translate frenchtl adine2menb_40be0483:

    # Ad normal b "I could read your past, present or future."
    Ad normal b "Je peux lire ton passé, ton présent ou ton futur."
...
translate frenchtl adine2menb_b4fdb6ce:
    ...
    Ad "Lire le passé peut sembler un peu étrange, car tu le connais déjà, mais ça peut peut-être t'aider à voir les choses sous un nouveau jour et te donner une nouvelle perspective."

# game/adine2.rpy:853
translate frenchtl adine2menb_06b47c2f:

    # Ad "Let me see what this card means..."
    Ad "Voyons voir ce que cette carte veut dire..."
...
# game/adine2.rpy:861
translate frenchtl adine2menb_4de8e1f8:

    # Ad normal b "What do you think about that?"
    Ad normal b "Que penses-tu de cela ?"

# game/adine2.rpy:869
translate frenchtl adine2menb_2c9c2915:

    # Ad think b "Is that so?"
    Ad think b "Vraiment ?"

# game/adine2.rpy:871
translate frenchtl adine2menb_be7b3cad:
...
# game/adine2.rpy:892
translate frenchtl adine2menb_5ec8084e:

    # c "This is very generic. You know that it's intentionally vague so everyone feels like it applies to them, right?"
    c "C'est très générique. Tu sais que c'est intentionnellement vague pour que tout le monde ait le sentiment que ça s'applique à eux, n'est-ce pas ?"

# game/adine2.rpy:894
translate frenchtl adine2menb_e994abe2:
...
# game/adine2.rpy:896
translate frenchtl adine2menb_9d0d3f05:
...
translate frenchtl adine2menb_88df5d81:
    ...
    Ad think b "Oh, c'est intéressant."
...
translate frenchtl adine2menb_f173471c:
    ...
    Ad "Vous serez à la croisée des chemins. Faites attention à vos décisions, car leurs conséquences pourraient être terribles. La prudence pourra avoir des résultats gratifiants, mais l'imprudence pourrait avoir des conséquences ayant plus d'impact que vous ne pouvez l'imaginer."

# game/adine2.rpy:926
translate frenchtl adine2menb_78cdb8e2:
...
# game/adine2.rpy:936
translate frenchtl adine2menb_bda1ddb5:
...
# game/adine2.rpy:938
translate frenchtl adine2menb_c3f43f0d:

    # c "That's good advice."
    c "C'est un bon conseil."

# game/adine2.rpy:945
translate frenchtl adine2menb_54c946a8:
...
# game/adine2.rpy:947
translate frenchtl adine2menb_6f49916d:
...
# game/adine2.rpy:956
translate frenchtl adine2menb_5ec8084e_1:

    # c "This is very generic. You know that it's intentionally vague so everyone feels like it applies to them, right?"
    c "C'est très générique. Tu sais que c'est intentionnellement vague pour que tout le monde ait le sentiment que ça s'applique à eux, n'est-ce pas ?"

# game/adine2.rpy:958
translate frenchtl adine2menb_bb359085:

    # Ad annoyed b "Well, you can't really expect a great amount of detail from a one card reading."
    Ad annoyed b "Tu ne peux pas vraiment t'attendre à beaucoup de détails à partir de la lecture d'une carte."

# game/adine2.rpy:960
translate frenchtl adine2menb_9d0d3f05_1:
...
# game/adine2.rpy:984
translate frenchtl adine2menb_0f173ebb:

    # c "What is it?"
    c "Qu'est-ce qu'il y a ?"

# game/adine2.rpy:986
translate frenchtl adine2menb_497f0dbd:

    # Ad "The card we've drawn is associated with drastic measures, particularly those with a final conclusion."
    Ad "La carte qu'on a tirée est associée avec des mesures drastiques, particulièrement celles avec une conclusion finale."
...
translate frenchtl adine2menb_5ec8084e_2:

    # c "This is very generic. You know that it's intentionally vague so everyone feels like it applies to them, right?"
    c "C'est très générique. Tu sais que c'est intentionnellement vague pour que tout le monde ait le sentiment que ça s'applique à eux, n'est-ce pas ?"

# game/adine2.rpy:1018
translate frenchtl adine2menb_bb359085_1:

    # Ad annoyed b "Well, you can't really expect a great amount of detail from a one card reading."
    Ad annoyed b "Tu ne peux pas vraiment t'attendre à beaucoup de détails à partir de la lecture d'une carte."

# game/adine2.rpy:1020
translate frenchtl adine2menb_9d0d3f05_2:

    # c "Yeah, I'm sure that's the reason."
    c "Ouais, c'est sûrement pour ça."

# game/adine2.rpy:1026
translate frenchtl adine2menb_e778aec1:
...
translate frenchtl adine2menb_f9e88f49:

    # Ad "Actually, yeah. It's not like I'm going to read the articles again."
    Ad "En fait, ouais. Ce n'est pas comme si j'allais relire les articles."

# game/adine2.rpy:1045
translate frenchtl adine2menb_f8368da4:
    ...
    Ad normal b "Mais je vais garder les cartes, parce que ce serait dommage de les jeter. Les images sont si artistiques et si jolies."

# game/adine2.rpy:1047
translate frenchtl adine2menb_9cefa3aa:
...
translate frenchtl adine2menb_14467b12:

    # Ad giggle b "Alright."
    Ad giggle b "Ça roule."

# game/adine2.rpy:1077
translate frenchtl adine2menb_93e0bca7:
...
translate frenchtl adine2menb_5b9fa8d9:
    ...
    Ad think b "Mais les choses vont toujours mal. Par exemple, imagine que tu as deux commandes à faire et que la première se passe sans accros, ok?"

# game/adine2.rpy:1095
translate frenchtl adine2menb_59ab7f92:

    # c "I'm imagining it very hard right now."
    c "Je l'imagine très clairement ouais."

# game/adine2.rpy:1097
translate frenchtl adine2menb_0ce1db36:
...
translate frenchtl adine2menb_f7af450f:
...
translate frenchtl adine2menb_c16905a7:
...
translate frenchtl adine2menb_4ad9854f:
...
translate frenchtl adine2menb_1277548e:
    ...
    c "Bien sûr. Je présume que ta participation est garantie maintenant ?"

# game/adine2.rpy:1133
translate frenchtl adine2menb_c5d42cb2:
...
translate frenchtl adine2menb_e962cf79:
...
translate frenchtl adine2skip_b341871b:
    ...
    Ad normal b "C'est une longue histoire, mais il y a quelque chose dont j'ai besoin. Tu connais certaines personnes au commissariat, n'est-ce pas ?"

# game/adine2.rpy:1149
translate frenchtl adine2skip_24c7ada5:

    # c "Yes?"
    c "Oui ?"

# game/adine2.rpy:1151
translate frenchtl adine2skip_45cb9ba5:

    # Ad think b "I think they're in possession of a map related to an underground building they found."
    Ad think b "Je pense qu'ils sont en possession d'une carte reliée à un bâtiment souterrain qu'ils ont découvert."

# game/adine2.rpy:1153
translate frenchtl adine2skip_ffece9d6:

    # c "I've heard about that."
    c "J'en ai entendu parlé."

# game/adine2.rpy:1155
translate frenchtl adine2skip_6dfd4551:
...
translate frenchtl adine2skip_fde92139:
...
translate frenchtl adine2skip_e2af3c5d:
    ...
    Ad "Tu vois ? Je pense que si tu mets ta parole en jeu, on pourrait y arriver facilement."

# game/adine2.rpy:1189
translate frenchtl adine2skip_ac60032b:

    # c "How do I even ask for something like that?"
    c "Comment puis-je même demander quelque chose comme ça ?"

# game/adine2.rpy:1191
translate frenchtl adine2skip_045604be:

    # Ad think b "You could always say that humanity is interested in it."
    Ad think b "Tu pourrais toujours dire que l'humanité y porte un intérêt."

# game/adine2.rpy:1193
translate frenchtl adine2skip_3ffe97ce:

    # c "Honestly, they probably would be."
    c "Honnêtement, ils pourraient en porter un probablement."

# game/adine2.rpy:1195
translate frenchtl adine2skip_700fa348:

    # Ad sad b "Could you ask them for me, please?"
    Ad sad b "Pourrais-tu leur demander pour moi, s'il te plait ?"

# game/adine2.rpy:1203
translate frenchtl adine2skip_12bd11ab:
...
translate frenchtl adine2skip_cb1f1990:
    ...
    c "Même si je le voulais, la police a des plus gros problèmes à gérer. Je ne veux pas les charger davantage en les obligeant à chercher pour un morceau de papier."

# game/adine2.rpy:1221
translate frenchtl adine2skip_f43faceb:

    # Ad disappoint b "Well, it was worth a shot."
    Ad disappoint b "Bien, ça valait le coup d'essayer."

# game/adine2.rpy:1226
translate frenchtl adine2skip_5fec0ad0:

    # c "I didn't know you were into archaeology."
    c "Je ne savais pas que tu aimais l'archéologie."

# game/adine2.rpy:1228
translate frenchtl adine2skip_f842cf75:
    ...
    Ad think b "Je m'en ficherais pas mal si ça s'avérait n'être qu'un vieux bâtiment. Le point intéressant repose sur le fait qu'elle fut construite par des humains."
...
translate frenchtl adine2skip_83335fed:
    ...
    Ad normal b "Eh bien, les mythes ne seraient plus vraiment mythiques si c'était le cas. On aurait une preuve."

# game/adine2.rpy:1234
translate frenchtl adine2skip_42be37ee:
...
translate frenchtl adine2skip_bb8abd2b:
    ...
    Ad normal b "\"Croire\" n'est pas le bon mot lorsque tu te tiens juste en face moi tu sais. Ça en soi c'est un miracle. J'en suis encore tout excitée rien qu'en y pensant."

# game/adine2.rpy:1242
translate frenchtl adine2skip_b487416b:
...
translate frenchtl adine2skip_83e05bed:
...
translate frenchtl adine2skip_571a5097:

    # Ad think b "Unless you want to sit in my empty apartment."
    Ad think b "À moins que tu veuilles traîner dans mon appartement vide."

# game/adine2.rpy:1254
translate frenchtl adine2skip_4d190ea2:

    # Ad normal b "You could always pay me a visit during practice sometime, if you like."
    Ad normal b "Tu pourrais toujours me rendre visite pendant un entraînement, si tu veux."

# game/adine2.rpy:1256
translate frenchtl adine2skip_be6b1835:

    # c "You mean your stunt flying practice?"
    c "Tu veux dire ton entrainement de vol acrobatique ?"

# game/adine2.rpy:1258
translate frenchtl adine2skip_4ff41815:

    # Ad giggle b "Yeah!"
    Ad giggle b "Ouais !"

# game/adine2.rpy:1260
translate frenchtl adine2skip_a75478a2:
...
translate frenchtl adine2skip_c48dc32f:
...
translate frenchtl adine2skip_f4c958b6:

    # Ad normal b "Yeah, please do."
    Ad normal b "Ouais, vas y."

# game/adine2.rpy:1339
translate frenchtl adine2skip_07558c77:

    # c "That almost sounds like you want me to leave."
    c "Ça sonnait presque comme si tu voulais que je parte."

# game/adine2.rpy:1341
translate frenchtl adine2skip_eecda5f5:

    # Ad "Because I do."
    Ad "Parce que je le veux."

# game/adine2.rpy:1343
translate frenchtl adine2skip_3bbeabf2:
...
translate frenchtl adine2skip_a069954c:
    ...
    c "Tu es juste trop sensible. Et ton magazine était stupide."
...
translate frenchtl strings:
    ...
    new "Chapitre 4 - Adine 2"

    # adine2.rpy:15
    old "Chapter 3 - Adine 2"
    new "Chapitre 3 - Adine 2"

    # adine2.rpy:19
    old "Chapter 2 - Adine 2"
    new "Chapitre 2 - Adine 2"

    # adine2.rpy:23
    old "Chapter 1 - Adine 2"
    new "Chapitre 1 - Adine 2"
    ...
    new "Je ne suis pas sûr quoi attendre de cela."
    ...
    new "Mon partenaire devrait être le chef."
    ...
    new "Qu'est-ce que cette question a à voir avec les relations ?"
    ...
    new "Tu sais que tout ça n'est pas réel, n'est-ce pas ?"
    ...
    # adine2.rpy:863
    old "It's not true."
    new "Ce n'est pas vrai."

    # adine2.rpy:863
    old "This is very generic."
    new "C'est très générique."
    ...
    new "Maintenant tu peux finalement le mettre dans la poubelle là où est sa place."
