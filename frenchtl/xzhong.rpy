...
translate frenchtl _call_skipcheck_31_ec1b5bd0:
    ...
    c "Pardonnez moi, mais je n'ai pas le souvenir que nous nous soyons convenablement présentés. Rappelez moi votre nom ?"

# game/xzhong.rpy:125
translate frenchtl _call_skipcheck_31_371533e6:

    # Wr "You can call me Zhong."
    Wr "Vous pouvez m'appeler Zhong."
...
translate frenchtl _call_skipcheck_31_ee0aacf5:
    ...
    c "Attendez... C'est Bryce là-bas qui dort sous la table ?"
...
translate frenchtl _call_skipcheck_31_e0ed9548:
    ...
    Zh normal b "Difficile à dire. Travailler ici au bar est bien plus agréable, mais ma place à l'épicerie est mieux payée et plus stable."
...
translate frenchtl _call_skipcheck_31_e025aa4a:
    ...
    c "Je remarque que vos portez un uniforme pour chacun de vos postes. C'est quelque chose qui ne semble pas courant ici."
...
translate frenchtl _call_skipcheck_31_8c4f4a51:
    ...
    Zh "Oui, mais ça reste simple en général. J'aime bien cette tenue, même si au bout d'un moment le noeud papillon peut sembler un peu serré."
...
translate frenchtl _call_skipcheck_31_fc063967:
    ...
    Zh normal b "N'est-il pas formidable ?"

# game/xzhong.rpy:186
translate frenchtl _call_skipcheck_31_e4e5b1a1:

    # Zh smile b "That's pretty accurate, I'd say."
    Zh smile b "Ce sont des mots qui lui correspondent plutôt bien, oui."
...
translate frenchtl _call_skipcheck_31_392c8ea9:
    ...
    Zh serv b "Si vous le trouvez un peu rude aujourd'hui, vous auriez dû le voir dans sa jeunesse. Un sacré petit trublion !"
...
translate frenchtl _call_skipcheck_31_b8b32ad9:
    ...
    c "J'ai l'impression que bien des gens lui font confiance en tant que chef de la police."

# game/xzhong.rpy:209
translate frenchtl _call_skipcheck_31_7b1cc9c3:

    # Zh serv b "They do, and rightfully so."
    Zh serv b "En effet, et c'est à juste titre."
...
translate frenchtl _call_skipcheck_31_012f5987:
    ...
    Zh "Oh, c'est une longue histoire en fait. Et ça me concerne plus que ça ne le concerne lui."

# game/xzhong.rpy:217
translate frenchtl _call_skipcheck_31_e1926fe6:

    # c "Come on, you can't just start like that and then not spill the beans."
    c "Allez, ne me laissez pas dans l'ignorance, vous avez commencé maintenant."

# game/xzhong.rpy:219
translate frenchtl _call_skipcheck_31_d4196c2e:

    # Zh serv b "Well, if you say so."
    Zh serv b "D'accord, comme vous voulez."
...
translate frenchtl _call_skipcheck_31_fb9a3bff:
    ...
    Hu "Et ne pense même pas à m'appeler \"papa\", okay ?"
...
translate frenchtl _call_skipcheck_31_dae933e9:
    ...
    Xu "Ne soit pas si vulgaire, Huang. Entre je t'en prie, je vais te servir un thé, d'accord ?"
...
translate frenchtl _call_skipcheck_31_8edfe662:
    ...
    Xu "Assieds toi, je nous prépare ça."
...
translate frenchtl _call_skipcheck_31_70a3a38d:
    ...
    Xu "Tu ne veux pas te joindre à nous, Huang ?"
...
translate frenchtl _call_skipcheck_31_f53df83c:
    ...
    Hu "Tu l'as fait entrer, c'est ton invité, pas le mien. Je ne veux pas être mêlé à tout ça."

# game/xzhong.rpy:323
translate frenchtl _call_skipcheck_31_7ed6c6f5:

    # Xu "I guess he doesn't want to talk."
    Xu "Eh bien, disont qu'il n'est pas d'humeur à parler aujourd'hui."
...
translate frenchtl _call_skipcheck_31_6bcd9523:
    ...
    Xu "J'aimerai te dire que je suis désolée, mais aucune de mes paroles ne peut réparer les erreurs du passé."
...
translate frenchtl _call_skipcheck_31_4a08749e:
    ...
    Xu "On a été contraints de te donner aux services de l'adoptions car nous étions jeunes, et stupides. Aujourd'hui nous ne sommes plus jeunes."
...
translate frenchtl _call_skipcheck_31_af327d4e:
    ...
    m "Après un moment, Xiuying est revenue s'asseoir à la table."
...
translate frenchtl _call_skipcheck_31_99d7b3b5:
    ...
    Xu "C'est un chapeau qu'on t'a offert quand tu étais petit. C'est l'un des rares souvenirs qu'il nous reste de cette époque."
...
translate frenchtl _call_skipcheck_31_d23acbfd:
    ...
    Xu "Tu veux encore un peu de thé ?"
...
# game/xzhong.rpy:375
translate frenchtl _call_skipcheck_31_5089a17b:
    ...
    Xu "Je ne te demande pas ça avec plaisir, mais tu n'aurais pas un peu d'argent pour nous ? Nous avons besoin de vivres, mais Huang n'aime pas aller chasser."
...
translate frenchtl _call_skipcheck_31_dbf6de84:
    ...
    Zh smile b "Plutôt bien je dirais. Tout le monde lui fait confiance et s'accorde à dire qu'il fait du bon travail."
...
translate frenchtl _call_skipcheck_31_35985209:
    ...
    Zh "Quel genre de musique vous aimez ?"
...
translate frenchtl _call_skipcheck_31_c7e0e48f:
    ...
    Zh serv b "On n'a qu'à passer quelques morceaux, et vous me direz ce que vous en pensez, d'accord ?"
...
translate frenchtl _call_syscheck_109_b0f97ae2:
    ...
    Zh serv b "Ah, quelque chose de simple. Vous savez ce qu'est un piano ?"

# game/xzhong.rpy:527
translate frenchtl _call_syscheck_109_1479faf4:

    # c "You can play the piano?"
    c "Attendez, vous savez jouer du piano ?"
...
translate frenchtl _call_syscheck_109_d72ad2af:
    ...
    Zh "Je suppose que ce n'est pas au goût de tous."
...
translate frenchtl zhongpianofinish_0588c4ea:
    ...
    Zh normal b "Voilà. Alors, ça vous a plu ?"
...
translate frenchtl zhongpianofinish_6657fb56:
    ...
    Zh serv b "Ce morceau est un vrai classique, probablement le plus vieux que nous connaissions."
...
translate frenchtl zhongclassicfinish_c2597d47:
    ...
    Zh normal b "Cet air est plutôt âgé."

# game/xzhong.rpy:672
translate frenchtl zhongclassicfinish_1141aea4:

    # c "I think I've heard it before."
    c "J'ai l'impression de l'avoir déjà entendu en fait."
...
translate frenchtl zhongclassicfinish_53a6e4d9:
    ...
    c "Non, pas ici. Mais probablement dans mon monde, avant d'avoir franchi le portail."
...
translate frenchtl zhongclassicfinish_50adbb2c:
    ...
    c "Peut-être avec quelques différences, mais suffisament semblable pour que je ne pense pas à une coïncidence."
...
translate frenchtl zhongclassicfinish_fabd36ac:
    ...
    Zh normal b "Si ce que vous dites est vrai, alors je ne pense pas être celui à qui vous devriez parler de ça."

# game/xzhong.rpy:684
translate frenchtl zhongclassicfinish_8c0b34a8:

    # c "I'll have to investigate this once I return to my own world."
    c "Je devrai enquêter à ce sujet lorsque je serais de retour dans mon monde."
...
translate frenchtl zhongclassicfinish_8ee7c6f8:
    ...
    Zh normal b "Oh, c'est trop fort pour vous peut-être ? J'ai oublié de prendre en compte le fait que vos oreilles sont peut-être plus sensibles que les nôtres."

# game/xzhong.rpy:725
translate frenchtl zhongclassicfinish_0a151957:

    # c "Let's just try something else."
    c "Non, ça va pour le volume. Mais essayons autre chose."

# game/xzhong.rpy:755
translate frenchtl zhongrockfinish_e8f5ae36:

    # Zh serv b "This is something a bit more modern."
    Zh serv b "Celle-ci est un peu plus moderne."

# game/xzhong.rpy:775
translate frenchtl zhongrockfinish_e7b9c707:

    # Zh normal b "What do you think?"
    Zh normal b "Qu'en pensez-vous ?"
...
translate frenchtl zhongrockfinish_d5f6429a:
    ...
    Zh "Oui, en effet. Mais peut-être pas idéale pour un bar comme celui là, cependant."
...
translate frenchtl zhongelectronicfinish_f7717c0b:
    ...
    Zh serv b "Celui-ci mets un peu de temps à partir, il va falloir faire preuve de patience."
...
translate frenchtl zhongcont_9dc5ccbb:
    ...
    c "La première chose qui vous vient à l'esprit quand vous rencontrez un visiteur étranger, c'est de l'inviter à sortir dans un endroit exotique ?"
...
translate frenchtl strings:
   ...
   # xzhong.rpy:1068
    ...
    new "Je pense qu'un peu des deux, ça peut être amusant."
