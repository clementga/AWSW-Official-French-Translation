...
translate frenchtl lorem4_7daa791a:
    ...
    Lo happy "Oh, ça doit être la sphère que tu as trouvée."
...
translate frenchtl _call_syscheck_29_696b18e0:
    ...
    s "Vous avez assemblé la Sphere Ixomen. À vrai dire, c'était Lorem. Ça devrait être son succès."
...
translate frenchtl _call_syscheck_29_6949ea4c:
    ...
    Lo happy "On dirait bien que c'est la sphère d'Ipsum. Il sera soulagé de savoir qu'elle a été retrouvée."
...
translate frenchtl _call_syscheck_29_2da780bb:
    ...
    Lo think "Pas vraiment grand chose. À moins que tu ne connaisses le mot de passe."
...
translate frenchtl _call_skiptut_5_0ff5f677:
    ...
    s "Mes enregistrements indique que vous avez déjà expérimenté cette séquence de manière satisfaisante. Voulez-vous passer jusqu'à la fin ?"
...
translate frenchtl _call_skipcheck_5_a1d6b4c8:
    ...
    Lo shy "Vraiment ? Oh, est-ce que ça à quelque chose à voir avec la disparition de Reza ?"

# game/lorem4.rpy:256
translate frenchtl _call_skipcheck_5_4c1100a6:

    # c "There's really no use denying it by this point."
    c "Il n'y a plus d'intérêt de le cacher à ce niveau là."
...
translate frenchtl _call_skipcheck_5_0250cd35:
    ...
    c "Depuis le jour de mon arrivée, en fait."
...
translate frenchtl _call_skipcheck_5_12c2c49a:
    ...
    Lo "Tu essayes de trouver Reza, c'est ça ? N'était-il pas ton ami ?"
...
translate frenchtl _call_skipcheck_5_cdae783a:
    ...
    Lo normal "Tu as raison. La foule deviendrait probablement folle si elle te voyait."
...
translate frenchtl _call_skipcheck_5_d9659792:
    ...
    c "Un dîner. Je t'ai invité pour dîner."
...
translate frenchtl _call_skipcheck_5_6f9d588a:
    ...
    Lo think "C'est juste une pizza, [player_name]. À quel point ça pourrait être mauvais ?"
...
translate frenchtl _call_skipcheck_5_8019707d:
    ...
    Lo happy "C'est le moins qu'il puisse faire, vu que tu l'as trouvée pour lui."
...
translate frenchtl _call_skipcheck_5_f54b8609:
    ...
    c "Tu as déjà touché la sphère. C'est trop tard pour la ranger maintenant."
...
translate frenchtl _call_skipcheck_5_8d9729d1:
    ...
    Lo think "Je pense que je vais choisir la salade comme garniture."
...
translate frenchtl _call_skipcheck_5_3995c4c8:
    ...
    c "Et après tu vas me dire que vous mangez vos pizzas avec une fourchette et une couteau."
...
translate frenchtl _call_skipcheck_5_b29f91e4:
    ...
    Lo "Et c'est fait. La commande est passée."
...
translate frenchtl _call_skipcheck_5_45fe28e4:
    ...
    m "Durant les 30 minutes qui suivirent, Lorem me montra plein d'autres fonctions (plus ou moins utiles) de la Sphère Ixomen. Il la fit léviter, me montra des sites web à l'allure primitive et l'utilisa même comme un modulateur de voix."

# game/lorem4.rpy:465
translate frenchtl _call_skipcheck_5_b458c268:

    # Lo normal "I'll just place the order, then."
    Lo normal "Je vais juste passer les commandes, alors."
...
translate frenchtl _call_skipcheck_5_fddccf01:
    ...
    m "Lorem se leva et se dirigea vers la porte. Du canapé, je ne pouvais rien voir, mais j'entendis un brin de conversation avant qu'il revienne à moi avec la boite carrée."

# game/lorem4.rpy:490
translate frenchtl _call_skipcheck_5_4beb0cf8:

    # Lo "The flyer who just delivered this - I actually know her."
    Lo "La personne qui vient de livrer ça - Je la connais en fait."
...
translate frenchtl _call_skipcheck_5_12e58c50:
    ...
    c "Je suppose que ce n'est pas inhabituel pour vous de vous connaître. Vos travails sont plutôt similaires."

# game/lorem4.rpy:494
translate frenchtl _call_skipcheck_5_1dbc7a83:

    # Lo think "I suppose. Some things never change in this town."
    Lo think "Je suppose. Certaines choses ne changent jamais dans cette ville."

# game/lorem4.rpy:500
translate frenchtl lorem4adinestatusneutral_6b92486a:

    # Lo happy "Guess who just delivered us this box of goodness."
    Lo happy "Devine qui vient juste de nous livrer cette boîte des délices."
...
translate frenchtl lorem4adinestatusneutral_993e5ac0:
    ...
    m "Lorem ouvrit la boîte et me montra la pizza que nous avions commandée. Les souvenirs de jours perdus fusaient dans ma tête."
...
translate frenchtl lorem4adinestatusneutral_f89a7a5e:
    ...
    c "N'avons-nous pas besoin de plus de personnes pour une fête ?"
...
translate frenchtl lorem4adinestatusneutral_56b71121:
    ...
    c "J'ai l'impression de pas avoir eu une pizza comme celle-là depuis des années."
...
translate frenchtl lorem4adinestatusneutral_63f60cde:
    ...
    Lo think "Je suppose que ça ne te dérange pas que nous ayons choisi chez Pantoli, hein?"
...
translate frenchtl lorem4adinestatusneutral_20a25e92:
    ...
    m "Sur ces mots, il prit une des parts de son côté et mordit dedans."
...
translate frenchtl lorem4adinestatusneutral_f3673877:
    ...
    Lo "Je me souviens maintenant pourquoi je n'avais pas commandé chez Pantoli depuis un moment. Leurs pizzas craignent."
...
translate frenchtl lorem4adinestatusneutral_cd61b479:
    ...
    c "À propos, comment avance ton jeu ?"
...
translate frenchtl lorem4adinestatusneutral_138584d3:
    ...
    c "Jusqu'à présent, tu es le seul qui a travaillé dessus, hein ?"
...
translate frenchtl lorem4adinestatusneutral_67f4a4c7:
    ...
    Lo relieved "Il ne serait jamais fini. Ou s'il l'est, ça pourrait être très différent de ce que j'aurais aimé qu'il soit, donc quelque chose doit changer."
...
translate frenchtl lorem4adinestatusneutral_3134032a:
    ...
    Lo "Je suppose que je suis juste inquièt, parce qu'une fois que tu impliques d'autre personne, les choses deviennent beaucoup plus compliquées."
...
translate frenchtl lorem4adinestatusneutral_017872a4:
    ...
    Lo think "J'ai toujours été dans mon coin, donc je ne suis pas sûr de pouvoir travailler avec une équipe. Tu dois trouver les gens, savoir commment les rémunérer et comment diviser le travail."
...
translate frenchtl lorem4adinestatusneutral_42d5809c:
    ...
    Lo relieved "Je suppose que je commence juste à réaliser quel type d'investissement ça va être."
...
translate frenchtl lorem4adinestatusneutral_47a8d321:
    ...
    Lo "Ouais, c'est génial et amusant de juste penser aux idées qui pourraient faire un jeu, mais une fois qu'on commence à travailler dessus, c'est une histoire complétement différente."

# game/lorem4.rpy:635
translate frenchtl lorem4adinestatusneutral_04469e93:

    # Lo think "At some point, it just becomes another job."
    Lo think "À un moment, ça devient juste un autre travail."
...
translate frenchtl lorem4adinestatusneutral_5740c729:
    ...
    Lo relieved "Bien sûr que si. Je savais que ça serait beaucoup de travail, mais je pense que je ne suis pas sûr que ça en vaille la peine."
...
translate frenchtl lorem4adinestatusneutral_cedc62a4:
    ...
    c "Cela dépend de pourquoi tu le fais dans un premier temps. La dernière fois tu disais que tu n'avais rien à perdre."
...
translate frenchtl lorem4adinestatusneutral_e1c23450:
    ...
    c "Si tu penses à ça, quelle est la pire chose qui pourrait arriver ?"
...
translate frenchtl lorem4adinestatusneutral_40f93983:
    ...
    Lo "Je pourrais décevoir ceux qui joueront au jeu, ceux qui auront travaillé avec moi, et puis enfin, moi-même."

# game/lorem4.rpy:657
translate frenchtl lorem4adinestatusneutral_86bf3be7:

    # c "That's what you're worried about?"
    c "C'est pour ça que tu t'inquiètes ?"
...
translate frenchtl lorem4adinestatusneutral_0ff54503:
    ...
    Lo think "C'est ce que ça fait d'être un créateur. Si tu mets une tonne de travail et d'effort dans quelque chose, tu veux que les gens l'apprécie, pas vrai ? Si ça n'arrive pas, pourquoi le faire alors ?"
...
translate frenchtl lorem4adinestatusneutral_f92786ad:
    ...
    c "Tu n'essaies pas d'impressioner qui que se soit, alors ce que les autres personnes pensent n'est pas important."
...
translate frenchtl lorem4adinestatusneutral_01e28b23:
    ...
    c "Regarde ce qui s'est passé avec Pantoli."
...
translate frenchtl lorem4adinestatusneutral_993b8f13:
    ...
    Lo "Elles sont peu chères et ça se ressent."
...
translate frenchtl lorem4adinestatusneutral_fa832478:
    ...
    c "Ils donnent juste ce que les gens veulent, et c'est ce qui leur permet de rester ouvert."
...
translate frenchtl lorem4adinestatusneutral_1bebbb4d:
    ...
    Lo "Tu essayes de dire que je ne réussirai pas si je n'offre pas ce que les gens cherchent ?"
...
translate frenchtl lorem4adinestatusneutral_68cfecf0:
    ...
    c "Non, je dis juste que si ton but n'est pas de réussir, tu n'as pas besoin de plaire à qui que ce soit."
...
translate frenchtl lorem4adinestatusneutral_4cc23d93:
    ...
    c "Parce que si tu fais ça, tu finiras sûrement comme Pantoli et tu te seras vraiment perdu."

# game/lorem4.rpy:691
translate frenchtl lorem4adinestatusneutral_a8f59156:

    # Lo think "I guess you have a point."
    Lo think "Je suppose que tu as raison."
...
translate frenchtl lorem4adinestatusneutral_25de2d5c:
    ...
    Lo normal "Je pense que tu as raison. Je devrais juste me concentrer sur les choses que je peux faire le mieux."
...
translate frenchtl lorem4adinestatusneutral_0cd53314:
    ...
    Lo relieved "Non, je pense que c'est juste qu'ils font des pizzas pas chères."
...
translate frenchtl lorem4adinestatusneutral_d56636bd:
    ...
    Lo "S'il y a une chose que la vie m'a appris, c'est que les gens ont peur de ce qu'ils ne connaissent pas."
...
translate frenchtl lorem4adinestatusneutral_9c3653dd:
    ...
    Lo "Je suppose que c'est une chose étrange à dire alors que les humains sont vénérés par beaucoup. Beaucoup d'entre eux ne connaissent aucun humain. Pas comme moi je te connais."
...
translate frenchtl lorem4adinestatusneutral_eb9d99fe:
    ...
    Lo sad "J'étais beaucoup malmené quand j'étais enfant."
...
translate frenchtl lorem4adinestatusneutral_32bee7f8:
    ...
    Lo "Tu sais, ça peut être assez rude quand tu grandis et que tous les autres enfants sont toujours plus grands que toi."
...
translate frenchtl lorem4adinestatusneutral_60496819:
    ...
    Lo sad "C'est juste bizarre pour une société qui célèbre nos différences, qu'il y ait des choses qui restent trop différentes même pour eux."
...
translate frenchtl lorem4adinestatusneutral_e3ce680e:
    ...
    Lo relieved "Quand j'ai grandi et suis allé à l'université, Je pensais que les gens se tiendraient mieux plutôt que de continuer à faire ces choses horribles, mais on m'a prouvé le contraire."
...
translate frenchtl lorem4adinestatusneutral_b79f7fe0:
    ...
    Lo sad "Leurs corps étaient peut-être ceux d'adultes, mais leurs coeurs étaient restés les mêmes qu'une décennie avant."
...
translate frenchtl lorem4adinestatusneutral_f80ec99e:
    ...
    Lo "Travailler sur moi a bien aidé, mais ce n'est qu'un traitement, pas la cause du problème."
...
translate frenchtl lorem4adinestatusneutral_ec9ec3fb:
    ...
    Lo "D'une certaine manière, je dois te le dire, parce que tu le découvriras un jour ou l'autre de toute façon - et quand ça arrivera, ça devrait être avec mes mots plutôt que ceux de quelqu'un d'autre."
...
translate frenchtl lorem4skip_685c6320:
    ...
    Lo "Je suis né avec les deux organes sexuelle - et avant que tu demandes, ce n'est pas quelque chose de commun dans aucune de nos espèces."
...
translate frenchtl lorem4skip_7c7ca72f:
    ...
    Lo "Dans les yeux de certains, ça fait de moi un monstre de la nature. Quelque chose qui a besoin d'être réparé, ou qui n'aurait jamais dû exister dans un premier temps."

# game/lorem4.rpy:763
translate frenchtl lorem4skip_1f5e134a:

    # Lo think "You don't?"
    Lo think "Tu t'en fiches ?"
...
translate frenchtl lorem4skip_6c0c02f5:
    ...
    c "C'est juste une autre part de qui tu es."
...
translate frenchtl lorem4skip_3ad0f1ce:
    ...
    Lo sad "Tu sais, ce n'est pas toujours les harceleurs qui me tombent dessus dès qu'ils l'apprennent."
...
translate frenchtl lorem4skip_8d1c47fa:
    ...
    Lo relieved "Donc, quand je rencontre une autre personne, je dois me préparer pour cette conversation - sans savoir s'ils ne vont pas subitement se retourner contre moi quand ils le sauront."
...
translate frenchtl lorem4skip_fea6169c:
    ...
    Lo sad "Certains se mettent en colère ou se moquent de moi. D'autre se sentent trahis et ne veulent plus rien avoir à faire avec moi."
...
translate frenchtl lorem4skip_0cfacc55:
    ...
    Lo sad "Comment je peux m'affirmer quand ceci peut arriver peu importe où je vais, tu vois ce que je veux dire ?"
...
translate frenchtl lorem4skip_b47f4c44:
    ...
    Lo "Cependant, je sais que tu ne peux interférer avec notre politique. Tu est un ambassadeur."
...
translate frenchtl lorem4skip_2bddfd6e:
    ...
    Lo "Tu penserais que ce ne sont que les brutes sans cervelles qui en ont après moi quand ils savent ça, mais trop souvent, ce sont ausssi les personnes que je pensais être mes amis."
...
translate frenchtl lorem4skip_ee7bce22:
    ...
    Lo "Donc, quand je rencontre une autre personne, je dois me préparer pour cette conversation - sans savoir s'ils ne vont pas subitement se retourner contre moi quand ils le sauront."
...
translate frenchtl lorem4skip_44f4d517:
    ...
    Lo "Comment je peux m'affirmer quand ceci peut arriver peu importe où je vais, tu vois ce que je veux dire ?"
...
translate frenchtl lorem4skip_b3b9f65a_1:
    ...
    # Lo "Doesn't mean I don't have hope that something like that will happen one day."
    Lo "Ça ne veut pas dire que je n'ai pas d'espoir que quelque chose comme ça arrive un jour."
...
translate frenchtl lorem4skip_05a7fbcb:
    ...
    Lo "Je devrais y aller maintenant. J'ai dit ce que j'avais à dire et je suis sûr que ça fait beaucoup à encaisser."
...
translate frenchtl lorem4skip_22b09d81:
    ...
    Lo relieved "Tu peux m'appeler dans quelques jours quand tu auras du temps pour y réfléchir ou si tu veux juste parler."
...
translate frenchtl lorem4skip_955a26d6:
    ...
    Lo "Mais ça ne veut pas dire que je me lamente pas sur les nombreuses opportunités perdues à cause de ça. Je déteste ça."
...
translate frenchtl lorem4skip_6dccd6cc:
    ...
    Lo sad "Mais ça ne me semblait pas juste."
...
translate frenchtl lorem4skip_f8bb1790:
    ...
    Lo relieved "Et encore, je dois juste me demander si toutes ces autres fois signifiaient quelque chose pour toi."
...
translate frenchtl lorem4skip_2f6263cf:
    ...
    Lo "Je veux dire, tu as fais ta part. Tu es venu à mon appartement et tu m'as laissé faire des dessins de toi."
...
translate frenchtl lorem4skip_842983b8:
    ...
    Lo "Tu m'as dit que je n'avais pas à m'en faire à propos de ce qu'il se passerait - et après ça, je ne m'inquiétais plus."

# game/lorem4.rpy:922
translate frenchtl lorem4skip_1617abd5:

    # Lo "And what did I do? Nothing."
    Lo "Et qu'est-ce que j'ai fait ? Rien."

# game/lorem4.rpy:924
translate frenchtl lorem4skip_bf121177:

    # Lo "I did nothing."
    Lo "Je n'ai rien fait."
...
translate frenchtl lorem4skip_60d371a6:
    ...
    Lo normal "Je me sens beaucoup mieux grâce à toi, cependant."
...
translate frenchtl lorem4skip_dab0b081:
    ...
    Lo "Hé, tu veux toujours qu'on aille voir le feu d'artifice ensemble ?"
...
translate frenchtl lorem4skip_a185d400:
    ...
    Lo "Très bien, appelle-moi dans quelque jours qu'on discute des détails."
...
translate frenchtl lorem4skip_1bcef64c:
    ...
    Lo "Très bien, à la prochaine alors."
...
translate frenchtl strings:
    ...
    new "C'est nouveau. Ça a l'air intéressant."

    # lorem4.rpy:395
    old "I'll take that as well."
    new "Je prendrai ça aussi."
