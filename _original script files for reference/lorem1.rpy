...
if persistent.lorem1skip == True:
    ...
    call syscheck from _call_syscheck_65

    call skiptut from _call_skiptut_16
    ...
    menu:
        ...
        "Yes. I want to skip ahead.":
            ...
            call skipcheck from _call_skipcheck_16
            
            scene bare #at Pan ((128, 228), (128,228), 0.0)

            show lorem happy
            with dissolvemed
            
            play music "mx/fountain.ogg" fadein 1.0
