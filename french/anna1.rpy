...
translate french anna1_8d584416:
    ...
    m "L'usine avait de nombreuses ailes différentes, recouvrant l'intégralité de la recherche au développement, avec en plus la production. Il était simple de s'y perdre si vous ne saviez pas où vous alliez."
...
translate french anna1_b230ba57:
    ...
    m "J'entendais de l'agitation au loin, et lorsque je me suis approché, je fus surpris de ne pas juste voir Anna, mais aussi Remy."
...
translate french anna1_64333f1a:
    ...
    m "Ils avaient l'air d'être au milieu d'une conversation enflammée. Je me suis dit qu'il était inapproprié de s'approcher maintenant, je suis donc resté plusieurs pas en arrière, hors de leur champ de vision, mais tout de même suffisament proche pour comprendre ce qu'ils disaient."
...
translate french anna1_a17387cd:
    ...
    An "Donc tu viens vers moi sur la base de rumeurs ? C'est comme ça que tu opères ? Que veux tu de moi ?"
...
translate french anna1_5e3528a3:
    ...
    An "Je ne sais pas de quoi tu parles."
...
translate french anna1_4dc4a125:
    ...
    An "Si tu voulais me menacer, tu aurais au moins pu envoyer quelqu'un de plus intimidant. Tu es peut-être plus grand que moi, mais même moi je peux voir que tu n'es qu'un gros lâche. Tu n'oserais pas poser tes sales griffes sur moi."
...
translate french anna1_3a3d127a:
    ...
    Ry "Je ne le ferais pas. Je suis ici par courtoisie, pas pour te menacer ou t'insulter. Fais ce que tu souhaites de cette information."

# game/anna1.rpy:64
translate french anna1_df29eec3:

    # Ry "You know we'll be back, and if they find anything, there will be consequences."
    Ry "Tu sais que nous reviendrons, et s'ils trouvent quoi que ce soit, il y aura des conséquences."

# game/anna1.rpy:65
translate french anna1_7ee0481f:

    # An "Do you think I care?"
    An "Tu crois que j'en ai quelque chose à faire?"
...
translate french anna1_28d33d90:
    ...
    m "Remy s'est retourné pour partir et a commencé à marcher dans ma direction. J'ai plongé derrière un pilier, et lorsqu'il est passé, je n'étais pas sûr de s'il m'avait vu. Dans tous les cas, il est parti, et je pouvais m'approcher sans risque."
...
translate french _call_skiptut_7_e7709aa0:
    ...
    s "Donc, il semblerait que vous ayez déjà vu ceci avant. Soit vous pourriez le regarder de nouveau, ou l'on pourrait vous faire gagner du temps et passer jusqu'à la fin de la scène."
...
translate french _call_skipcheck_7_baa3667a:
    ...
    An "Ce n'est pas important de toutes façons. Ce n'est qu'un morceau du parcours pour moi."
...
translate french _call_skipcheck_7_5a61a232:
    ...
    An "Le culot de ce type. Il ne serait probablement pas si tendu si ce n'était pour cette histoire avec sa petite amie quelques années auparavant."
...
translate french _call_skipcheck_7_981a8a46:
    ...
    c "De quelle sorte de recherches sommes-nous en train de parler?"
...
translate french _call_skipcheck_7_ec71e0ee:
    ...
    c "Je pensais que tu voulais me montrer, étant donné que nous travaillons tous les deux dans la biologie et tout ça."
...
translate french _call_skipcheck_7_809161f6:
    ...
    An "Il est bon de constater que nos visions convergent sur ce point."
...
translate french _call_skipcheck_7_3f4c75b3:
    ...
    An "Excuse-moi un instant, mais je dois pleurer pour la langue Française. À ce niveau, pourquoi ne dis-tu pas que tu es le \"plus curieux\" ?"
...
translate french _call_skipcheck_7_84a1d6ad:
    ...
    c "Dans tous les cas, si tu dois faire des heures supplémentaires aujourd'hui, est-ce que ça signifit que je dois t'attendre, ou préfères-tu que je revienne une autre fois ?"

# game/anna1.rpy:318
translate french _call_skipcheck_7_d1affb50:

    # An "Neither, I think my break should start right about... now."
    An "Ni l'un, ni l'autre, ma pause devrait commencer, disons... Maintenant."
...
translate french _call_skipcheck_7_8a39980d:
    ...
    An "Tant que tu ne me dénonces pas, ça ne devrait pas être un problème."
...
translate french _call_skipcheck_7_2b65165b:
    ...
    An "Nous verrons si c'est aussi le mien."
...
translate french _call_skipcheck_7_db180c37:
    ...
    An "Enfin. J'ai hâte d'avoir du café dans mon système sanguin."
...
translate french _call_skipcheck_7_c97a6805:
    ...
    Ad "Je suis navrée. Laissez-moi recommencer."
...
translate french _call_skipcheck_7_beab5379:
    ...
    Ad "Soyez les bienvenus dans notre établissement. Mon nom est Adine, et je serai votre serveuse aujourd'hui. Que puis-je vous apporter ?"

# game/anna1.rpy:449
translate french _call_skipcheck_7_24bf5684:

    # An "I'll have a coffee."
    An "Je prendrai un café."
...
translate french _call_skipcheck_7_9d9d1b9a:
    ...
    Ad "Je vous remercie. Et que puis-je ramener à cet estimé gentleman de l'autre coté de la table ?"
...
translate french _call_skipcheck_7_e2d0e6cd:
    ...
    An "C'est quoi son problème ? Je suis là pour commander quelque chose, pas pour faire la causette avec les employés."
...
translate french _call_skipcheck_7_5343140e:
    ...
    An "Où veux-tu en venir ?"

# game/anna1.rpy:522
translate french _call_skipcheck_7_3a37edec:

    # c "What's your job there? I mean, what do you do, exactly?"
    c "Quel est ton travail là-bas ? Je veux dire, qu'est-ce que tu y fais exactement ?"
...
translate french _call_skipcheck_7_6cb0e058:
    ...
    An "C'est plutôt pratique, puisque tu peux aller de la recherche jusqu'aux tests et même jusqu'à la fabrication, et le tout dans le même complexe."
...
translate french _call_skipcheck_7_71fb7109:
    ...
    An "Bien entendu, ça signifie plus de travail, mais ça me permet aussi de réaliser quelques projets personnels de temps à autres. Cela satisfait-il ta curiosité?"
...
translate french _call_skipcheck_7_7318a035:
    ...
    An "Peut-être que je devrais. Je lui dirai que tu m'a touché, et ensuite je te poursuivrai pour des dédommagements."
...
translate french _call_skipcheck_7_169504fd:
    ...
    An "Dans ce cas tu dois parler d'Adine, la serveuse suppliante, ou de toi, parce que tu ne m'a pas encore vue de mauvaise humeur. Je n'étais pas même proche de l'être."
...
translate french _call_skipcheck_7_9e671d0d:
    ...
    c "Que fais-tu durant ton temps libre ? Avoir un bon équilibre entre ta vie et ton travail est très important, tu sais."
...
translate french _call_skipcheck_7_f3734192:
    ...
    An "J'aime mon travail, vraiment. En fait, je l'aime tellement que même dans mon temps libre, je fais toujours des choses en rapport avec la biologie."
...
translate french _call_skipcheck_7_a9f2c31d:
    ...
    An "Comme je l'ai dit, j'ai l'opportunité de faire mes propres projets de temps en temps, alors c'est ce sur quoi je me concentre quand j'en ai la chance. Ce serait dommage de rater une opportunité comme celle-ci sans l'utiliser."
...
translate french _call_skipcheck_7_d009f7ee:
    ...
    c "Je ne sais pas. As-tu d'autres loisirs ?"
...
translate french _call_skipcheck_7_33bb994f:
    ...
    c "Avez-vous quelque chose pour occuper vos clients ? Des jeux ou autres distractions ?"
...
translate french _call_skipcheck_7_5877796a:
    ...
    An "Qu'essayes-tu de faire exactement ?"
...
translate french _call_skipcheck_7_e658b925:
    ...
    # c "I know it's not Knizki's {i}Textile Merchant{/i}, but I suppose it's better than nothing." TODO boardgame
    c "Je sais que ce n'est pas le {i}Marchand de Textile{/i} de Knizki, mais je suppose que c'est mieux que rien."
...
translate french _call_skipcheck_7_1be57190:
    ...
    An "Mais si je gagne, je te ferai venir un jour afin de pouvoir faire quelques tests sur toi."
...
translate french _call_skipcheck_7_73ed9de4:
    ...
    An "Mais si je gagne, je te ferai venir un jour afin de pouvoir faire quelques tests sur toi. Je n'aurai même plus besoin de ton sang."
...
translate french _call_skipcheck_7_175760ef:
    ...
    An "Peut-être devrais-tu jouer à ton jeu pour enfants avec la serveuse, parce que j'ai des choses plus intéressantes à faire."
...
translate french _call_skipcheck_7_3a429c00:
    ...
    m "Je vis de la malice dans ses yeux. son regard était perçant, allant de pair avec son petit sourire satisfait et arrogant qui exposait son anticipation. Elle semblait certaine qu'elle gagnerait et en savourerait chaque seconde."

# game/anna1.rpy:785
translate french _call_skipcheck_7_3c8056a2:

    # m "Slowly, her hand went over to the deck of cards and drew the topmost."
    m "Doucement, sa main se dirigea vers le paquet de cartes et piocha la première."
...
translate french _call_skipcheck_7_2fa2fb8c:
    ...
    An "Comment pouvais-tu savoir ça? tu n'es là que depuis, quoi, quelques jours ?"
...
translate french _call_skipcheck_7_0e088460:
    ...
    An "Tu ne seras pas aussi chanceux la prochaine fois."
...
translate french cont1_b3f8bf41:
    ...
    c "Voyons comment tu vas te débrouiller avec ta première question."
...
translate french cont1_d66fe21d:
    ...
    An "Bien, s'il y a cinq pommes et que tu en prends trois, combien as-tu de pommes ?"

# game/anna1.rpy:898
translate french cont1_bfc11f19:

    # An "Guess you also know your trick questions."
    An "Il semblerait que tu connaisses aussi ces questions-pièges."
...
translate french wrong2_7c631ae3:
    ...
    An "Non. Il s'agit là d'une question-piège, vois-tu. La bonne réponse était trois, car c'est le nombre de pommes que tu as pris."
...
translate french cont2_735eded7:
    ...
    c "Encore juste. Aurais-tu déjà joué à ce jeu auparavant ?"
...
translate french cont2_ac54beca:
    ...
    An "#1: Une salle remplie de gaz empoisonné. #2: Une salle dans laquelle se trouvent cent assassins sur-entraînés. #3: Une salle plongée dans l'eau avec des alligators qui n'ont pas mangé depuis huit mois."
...
translate french cont2_eda2a1fe:
    ...
    An "Ne t'en fais pas, je vais tout de même compter la réponse comme étant correcte pour toi. Pas besoin de te faire attraper la queue coincée dans la porte pour ça."
...
translate french wrong3_4100da8d:
    ...
    An "C'est faux. Dans les faits, toutes les salles sont aussi mortelles les une que les autres. Les alligators peuvent survivre jusqu'à deux ans sans nourriture, ce qui rend la salle #3 aussi mortelle que les autres. Les deux autres salles ne devraient pas requérir d'explications."
...
translate french wrong3_a3dabf65:
    ...
    An "On dirait que tu n'apprécies plus tellement jouer à ce jeu au final."
...
translate french _call_syscheck_36_69150ed7:
    ...
    s "Tu as bien répondu aux questions d'Anna. Sens-toi libre d'imaginer une pluie de confettis, si ça te fait du bien."
...
translate french _call_syscheck_36_6238581e:
    ...
    An "Je n'aurai pas d'endroit dans le laboratoire pour faire les tests pendant un moment, donc je suppose que notre prochaine rendez-vous sera un rencart."
...
translate french _call_syscheck_36_20265dca:
    ...
    An "Bien entendu. Et je ferai en sorte d'être sûre que tu accomplisses ta part du marché."
...
translate french _call_syscheck_36_4e513385:
    ...
    n "Même si mon pari de la forcer a faire un vrai rencart ensemble était plus dû à son impolitesse plus tôt, mais je ne m'attendais pas a ce résultat. Je n'étais même pas certain de ce que j'attendais de ce rendez-vous en premier lieu, mais maintenant j'étais forcé d'aller a un rencart avec elle, mais aussi d'être son cobaye personnel."

# game/anna1.rpy:1094
translate french _call_syscheck_36_7f2e72b6:

    # n "Whether anything good would come of this, I wasn't sure, either."
    n "Je n'étais pas non plus sûr que quelque chose de bon ressorte de tout ça."

# game/anna1.rpy:1123
translate french anna1skip_e7d90bc0:

    # An "Just look at that, I won."
    An "Regarde ça, j'ai gagné."

# game/anna1.rpy:1124
translate french anna1skip_4a4ac067:

    # c "Someone had to."
    c "Quelqu'un devait bien gagner."
...
translate french anna1skip_b1004111:
    ...
    An "Ça aura finalement été plus amusant que ce que je pensais. Évidemment, la raison principale aura été le fait que j'ai gagné, mais même..."

# game/anna1.rpy:1127
translate french anna1skip_f3e7a485:

    # c "I get it. You won, you're great, et cetera."
    c "J'ai compris. Tu a gagné, tu es géniale, et cetera."
...
translate french anna1skip_ee815ce8:
    ...
    An "En fait, je ne pense pas avoir un coin où faire les tests dans le laboratoire pendant un moment, mais je ferai en sorte que tu sois averti aussitôt que j'en ai un."

# game/anna1.rpy:1133
translate french anna1skip_0a6adcc2:

    # c "I'm quite sure you will."
    c "Je suis certain que tu m'avertiras à la seconde près."
...
translate french anna1skip_f5f06e56:
    ...
    An "Bien sûr. Certes, tu n'as pas gagné, mais je pense que tu l'as tout de même mérité. Ou alors je suis juste tellement gentille."
...
translate french anna1skip_b9e3523e:
    ...
    An "Tu peux parier dessus. Dans tous les cas, il faut que j'y aille. Ma \"pause\" va se terminer sous peu. À la revoyure."
...
translate french anna1skip_4190e1e7:
    ...
    n "Je n'étais pas sûr de ce que j'attendais de cette rencontre, mais il est certain que ce n'était pas ça."
...
translate french anna1skip_1935d8cf:
    ...
    n "Même si j'avais perdu le pari, elle n'a pas l'air d'être dérangée à l'idée d'aller à un rencart avec moi, tant qu'elle obtenait ce qu'elle voulait. Mais vouloir continuer sur cette voie ou non était un choix qui me revenait."

# game/anna1.rpy:1182
translate french anna1skip_5a69d41d:

    # An "And in a twist of fate that shocked no one, Anna, the magnificent, won the game."
    An "Et dans une tournure du destin qui ne choqua personne, Anna, la grande et puissante, remporta la partie."
...
translate french anna1skip_840cf566:
    ...
    An "C'est quoi ton problème ? Je l'ai mérité."
...
translate french anna1skip_86f05589:
    ...
    An "Ça ne te posait pas de problème en proposant de jouer à ce stupide jeu. Tu sais que tu es un mauvais perdant ?"
...
translate french anna1skip_35135016:
    ...
    An "Je pense que tu es juste en train d'expérimenter une douleur postérieur aigüe, parce que tu ne pourras pas aller à un rencart avec moi."
...
translate french anna1skip_6af3e46d:
    ...
    c "Je ne voulais pas même aller à un rencart avec toi en premier lieu. Je voulais juste t'apprendre quelques manières."
...
translate french anna1skip_44223133:
    ...
    An "Parce que tu serais evidemment un tellement bon professeur, la manière dont tu respires les vertues telles la politesse et l'humilité, et d'avoir essayé de forcer quelqu'un à aller à un rencart avec toi sur un pari."

# game/anna1.rpy:1198
translate french anna1skip_0eabec36:

    # c "Maybe you should step down from your high horse for once."
    c "Peut-être devrais-tu descendre de tes grands chevaux pour une fois."
...
translate french anna1skip_b7bca3d1:
    ...
    An "Tu me critique, mais tu es tellement hypocrite. Je ne comprends même pas ce que tu me racontes. Qu'est-ce qu'un cheval ?"
...
translate french anna1skip_b8212a9e:
    ...
    An "Non, plus depuis que l'un d'entre nous pense qu'il est, d'une manière ou d'une autre, supérieur à l'autre. D'où vient ce soudain complexe de supériorité ?"
...
translate french anna1skip_9ceffd57:
    ...
    An "Juste parce que, oh mon dieu, tu es humain et tu pense mériter un traitement spécial ? Tu es juste comme Reza de ce point de vue."
...
translate french anna1skip_fee6d309:
    ...
    An "Tu sais quoi ? Je pars, mais ne t'attends pas une seconde que je ne vais pas faire en sorte d'être sûre et certaine que tu remplisses ta part du marché."
...
translate french strings:
    ...
    new "Tu me feras la visite une autre fois, dans ce cas."
    ...
    new "J'espère que personne ne verra ta pause non planifiée."
    ...
    new "Totalement. Tu peux appeler ton avocat si tu le souhaites."
    ...
    new "Très bien, je finirai ma boisson tranquillement, si c'est ce que tu préfères."

    # anna1.rpy:578
    old "Okay, I guess you don't like questions, then."
    new "Okay, je suppose que tu n'aimes donc pas les questions."

    # anna1.rpy:578
    old "Excuuuse me, princess."
    new "Excuuusez-moi, princesse."

    # anna1.rpy:640
    old "Anything to get you to shut up about work already."
    new "N'importe quoi pour que tu arrêtes de parler de travail."
    ...
    new "#2, la salle avec les cent assassins sur-entrainés."

    # anna1.rpy:965
    old "#3, the room submerged in water filled with alligators that have not eaten in eight months."
    new "#3, La salle submergée par de l'eau, avec des alligators qui n'ont pas mangé depuis huit mois."
    ...
    new "Cette question est mal rédigée."
